...
<body>
  ...
  <div class="row">
	<div class="col-sm-6">
  <h2>Accessment Completion Time</h2>
  <p><xsl:value-of select="/AnalyzerReport/Accessment_Time"/></p>
    ...
    <xsl:for-each select="//BugInstance">
        ...
        <td class="file"><xsl:value-of select="BugLocations/Location[@primary='true']/SourceFile"/></td>
        ...
        <td class="message"><xsl:value-of select="BugMessage"/></td>
        <td class="resolution"><xsl:value-of select="ResolutionSuggestion"/></td>
        </tr>
    </xsl:for-each>
  </tbody>
    </table>
