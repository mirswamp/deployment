...
<xsl:if test="BugGroup = 'Unix API'">p1</xsl:if>
<xsl:if test="BugGroup = 'API'">p2</xsl:if>
<xsl:if test="BugGroup = 'Dead store'">p3</xsl:if>
<xsl:if test="BugGroup = 'Logic error'">p4</xsl:if>
<xsl:if test="BugGroup = 'Memory Error'">p5</xsl:if>
<xsl:if test="BugGroup = 'Security'">p6</xsl:if>
</xsl:template>
<xsl:template match="/">
<html>
<head>
