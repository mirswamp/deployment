...
<xsl:if test="BugSeverity = '1'">p1</xsl:if>
<xsl:if test="BugSeverity = '2'">p2</xsl:if>
<xsl:if test="BugSeverity = '3'">p3</xsl:if>
<xsl:if test="BugSeverity = '4'">p4</xsl:if>
<xsl:if test="BugSeverity = '5'">p5</xsl:if>
<xsl:if test="BugSeverity = '6'">p6</xsl:if>
</xsl:template>
<xsl:template match="/">
<html>
<head>
    <title><xsl:value-of select="/AnalyzerReport/@tool_name"/> <xsl:value-of select="/AnalyzerReport/@tool_version"/> Report</title>
...
<!--
 ...
 <!--This line is used as a delimiter to locate the position of the Native Viewer Header,
    ...
    <h2>Summary</h2>
    <table class="summary" border="0" width="100%"><thead>
      <tr>
    ...
    <table class="results" border="0" width="100%"><thead>
            <tr>
				<th><i class="fa fa-bug"></i><span> Priority</span></th>
                ...
                <th align="left"><i class="fa fa-wrench"></i><span> Resolution</span></th>
            </tr>
    </thead>
    <tbody>
    <xsl:for-each select="//BugInstance">
        <tr>
        <td class="priority" ><xsl:value-of select="BugSeverity"/></td>
        <td class="group" ><xsl:value-of select="BugGroup"/></td>
        <td class="code" ><xsl:value-of select="BugCode"/></td>
        <td class="file" align="left"><xsl:value-of select="BugLocations/Location[@primary='true']/SourceFile"/></td>
        <xsl:if test="$numLine > 0"> 
        <td class="line" ><xsl:value-of select="BugLocations/Location[@primary='true']/StartLine"/></td>
       	</xsl:if> 
		<xsl:if test="$numColumn > 0"> 
        <td class="col" ><xsl:value-of select="BugLocations/Location[@primary='true']/StartColumn"/></td>
       	</xsl:if> 
		<td class="message" align="left"><xsl:value-of select="BugMessage"/></td>
        <td class="resolution" align="left"><xsl:value-of select="ResolutionSuggestion"/></td>
        </tr>
    </xsl:for-each>
    </tbody>
    </table>
