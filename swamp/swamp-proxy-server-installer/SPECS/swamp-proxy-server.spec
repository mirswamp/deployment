...
#
# spec file for SWAMP proxy server installation RPM
#
%define _arch noarch
...
Summary: Proxy Server installation for Software Assurance Marketplace (SWAMP)
Name: swamp-proxy-server
...
%attr(0400, apache, apache) %config /var/www/swamp-proxy-server/.env
%attr(0755, apache, apache) /var/www/swamp-proxy-server/storage/app
%attr(0755, apache, apache) /var/www/swamp-proxy-server/storage/framework
%attr(0755, apache, apache) /var/www/swamp-proxy-server/storage/framework/cache
%attr(0755, apache, apache) /var/www/swamp-proxy-server/storage/framework/sessions
%attr(0755, apache, apache) /var/www/swamp-proxy-server/storage/framework/views
%attr(0755, apache, apache) /var/www/swamp-proxy-server/storage/logs

/var/www/html/*
/var/www/html/.[A-Za-z]*
/var/www/swamp-proxy-server
...
#
if [ -r /var/www/swamp-proxy-server/.env.rpmsave ]; then
    src=/var/www/swamp-proxy-server/.env.rpmsave
    dest=/var/www/swamp-proxy-server/.env
...
chown apache:apache /var/www/swamp-proxy-server/.env
chmod 0400          /var/www/swamp-proxy-server/.env
