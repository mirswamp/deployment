...
function build_rpms() {
	...
	# example: ../singleserver/sbin/swampinabox_build_rpms.bash swampinabox ../../../../swamp 1.27.0.SWAMPINABOX_RELEASE 0
	../singleserver/sbin/swampinabox_build_rpms.bash swampinabox $WORKSPACE $RELEASE_NUMBER $BUILD_NUMBER
}
...
function release_tar_files() {
    ...
    platforms_bundle=$(find "$RELEASE_ROOT" -name 'build_swampinabox-platforms-*.tar.gz' | sort -r | head -n 1)
