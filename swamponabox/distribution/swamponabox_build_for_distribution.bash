...
function build_rpms() {
	...
	# example: ../singleserver/build_swamponabox_rpms.bash ../../../../swamp 1.27.0.SWAMPINABOX_RELEASE 0
	../singleserver/sbin/swamponabox_build_rpms.bash swamponabox $WORKSPACE $RELEASE_NUMBER $BUILD_NUMBER
}
...
function build_src_tar() {
	...
	rm $BUILD_RESULT/sbin/swamponabox_build_rpms.bash
	...
	cp -r ../singleserver/swamponabox_installer $BUILD_RESULT/.
	cp -r ../singleserver/swamponabox_web_config $BUILD_RESULT/.
